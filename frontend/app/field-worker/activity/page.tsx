      ...
      <div className="bg-white rounded-xl shadow-sm p-4 sm:p-6 border border-gray-200">
        <div className="flex items-center gap-3 sm:gap-4">
          <div className="bg-blue-100 p-3 sm:p-4 rounded-full">
            <Activity className="w-5 h-5 sm:w-6 sm:h-6 lg:w-8 lg:h-8 text-blue-600" />
          </div>
          <div>
            <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-800">My Activity</h1>
            <p className="text-sm sm:text-base text-gray-600">Track all your issue activities and updates</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200">
        ...
        {issues.length === 0 && (
          <div className="px-4 sm:px-6 py-8 sm:py-12 text-center">
            ...
            <p className="text-gray-500 text-sm sm:text-base">No activity found</p>
            <p className="text-xs sm:text-sm text-gray-400 mt-2">Your issue activities will appear here</p>
          </div>
        )}
      </div>
